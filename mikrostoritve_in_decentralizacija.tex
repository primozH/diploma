...
Gre za \sn{lahko} obliko virtualizacije, ki tu poteka na nivoju procesov in ne na nivoju operacijskega sistema.
...
Storitve se izvajajo distribuirano (porazdeljeno) in replicirano, pogosto na fizično ločenih sistemih, kar zagotavlja visoko stopnjo odzivnosti in dosegljivosti. Razpoložljivost in dosegljivost storitev se danes meri predvsem na peti ali šesti decimalki, t.i. \sn{število devetk} (number of nines).
...
Tipično so za potrjevanje blokov in novih transakcij uporabljene \sn{kripto valute}, pridobljene s t.i. postopkom rudarjenja.
...
S tem področjem se trenutno aktivno ukvarjajo tudi pri startupu SONM, ki obljublja računsko moč na zahtevo v decentraliziranem okolju. Iz oblačnega računalništva želijo preiti na t.i. \sn{računalniške storitve v megli} (fog computing) \cite{Sonm}.
